...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DOM */ \"./src/DOM.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\nconst content = document.querySelector('#content');\n\nconst Todo = (() => {\n\n  const _NavBar = (()=> {\n    const categories = ['Inbox', 'Today', 'This Week']; // convert to objects\n    const _loadCategories = (parent) => {\n      const categoriesContainer = _DOM__WEBPACK_IMPORTED_MODULE_0__[\"default\"].createContainer(parent, 'categories');\n        categories.forEach(category => {\n          _DOM__WEBPACK_IMPORTED_MODULE_0__[\"default\"].createButton(categoriesContainer, category);\n        })\n    }\n    const _loadProjects = (parent) => {\n      const projectsContainer = _DOM__WEBPACK_IMPORTED_MODULE_0__[\"default\"].createContainer(parent, 'projects');\n        _DOM__WEBPACK_IMPORTED_MODULE_0__[\"default\"].createHeading(projectsContainer, 'h2', 'Projects');\n        _DOM__WEBPACK_IMPORTED_MODULE_0__[\"default\"].createButton(projectsContainer, '+ Add Project');\n    }\n    const load = (parent) => {\n      const container = _DOM__WEBPACK_IMPORTED_MODULE_0__[\"default\"].createContainer(parent, 'navbar');\n      _loadCategories(container);\n      _loadProjects(container);\n    }\n\n    return { load };\n  })();\n\n  const _Main = (() => {\n    const load = (parent) => {\n    }\n    \n    return { load };\n  })();\n  \n  const load = (parent) => {\n    _NavBar.load(parent);\n    // const navbar = DOM.createContainer(parent, 'navbar');\n    // const main = DOM.createContainer(parent, 'main');\n  }\n\n  return { load };\n})();\n\nTodo.load(content);\n\n//# sourceURL=webpack://todo/./src/index.js?");
